...
abstract class ResourceInformation {
	...
	public function getPublicResourceUri($resource) {
		return $this->getPublicUri($resource, $this->resourceControllerActionName, $this->getResourceControllerArguments($resource));
	}
	...
	public function getPublicRelationshipUri($resource, $relationshipName) {
		return $this->getPublicUri($resource, $this->resourceControllerActionName, $this->getRelationshipControllerArguments($resource, $relationshipName));
	}
	...
	public function getPublicRelatedUri($resource, $relationshipName) {
		return $this->getPublicUri($resource, $this->relatedControllerActionName, $this->getRelationshipControllerArguments($resource, $relationshipName));
	}
	...
	protected function getPublicUri($resource, $controllerActionName, array $controllerArguments = array()) {
		...
		return new \TYPO3\Flow\Http\Uri($uri);
	}
